...
Дата проверки: 23 сентября 2026. Рабочая ветка: `feature/licensing-and-trial`.
...
- Активация, проверка и деактивация текущего Mac подключены к публичному Lemon
  ...
  повторно проверяет лицензию раз в 7 дней. Тестовый продукт доступен только в
...
На рабочем дереве 23 сентября полный `PasteQueueTests` прошёл: **89 тестов,
0 ошибок**. Команда:
