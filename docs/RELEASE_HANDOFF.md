...
- Активация, проверка и деактивация текущего Mac подключены к публичному Lemon
  ...
  ошибки проверка повторяется через 6 часов. Тестовый продукт доступен только в
  Debug; Release ждёт live IDs и checkout URL.
...
5. Заполнить production IDs и checkout Lemon Squeezy, пройти live-покупку,
